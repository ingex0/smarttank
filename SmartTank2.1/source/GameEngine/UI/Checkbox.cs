...
namespace GameEngine.UI
{
    public class Checkbox : Control
    {
        ...
        #region Consturction
        public Checkbox( string name, Vector2 position, string text, bool bChecked )//, Font font, Form.Style style )
        {
            ...
            texture[0] = BaseGame.ContentMgr.Load<Texture2D>( Path.Combine( Directories.UIContent, "checkbox" ) );
            texture[1] = BaseGame.ContentMgr.Load<Texture2D>( Path.Combine( Directories.UIContent, "checkbox_checked" ) );
