...
{
    public class TextButton2 : Control
    {
        #region Variables
        ...
        public TextButton2( string name, Vector2 position, string text, Nullable<int> width, /*Font font,*/ Color color )//, Style style)
        {
        ...
        {
            buttonTexture = BaseGame.ContentMgr.Load<Texture2D>( Path.Combine( Directories.UIContent, "button2" ) );
        ...
        public override void Draw( SpriteBatch spriteBatch, float alpha )
        {
            ...
            Color dynamicTextColor = new Color( new Vector4( 1f, 1f, 1f, alpha ) );
