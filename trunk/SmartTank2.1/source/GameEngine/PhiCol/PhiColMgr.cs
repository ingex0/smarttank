...
namespace GameEngine.PhiCol
{
    ...
    public class PhiColMgr
    {
        ...
        private void CheckOverlap ()
        {
            ...
            {
                group.colA.ColChecker.HandleOverlap( group.result,group.colA, group.colB );
                group.colB.ColChecker.HandleOverlap( new CollisionResult( group.result.InterPos, -group.result.NormalVector ),group.colB, group.colA );
            }
        ...
        private void HandleCollision ( bool CallHandleCollision )
        {
            ...
            foreach (CollisionResultGroup group in colResults)
            {
                group.colA.ColChecker.HandleCollision( group.result,group.colA, group.colB );
                group.colB.ColChecker.HandleCollision( new CollisionResult( group.result.InterPos, -group.result.NormalVector ),group.colB, group.colA );
            }
