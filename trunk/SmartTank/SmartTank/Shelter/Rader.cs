...
namespace SmartTank.Shelter
{
    ...
    public class Rader : IDrawableObj
    {
        ...
        public void Draw ()
        {
            ...
            if (texture != null)
            {
                BaseGame.SpriteMgr.alphaSprite.Draw( texture, BaseGame.CoordinMgr.ScreenPos( pos ),
                    null, Color.White, 0, new Vector2( BaseGame.CoordinMgr.ScrnLengthf( r ), BaseGame.CoordinMgr.ScrnLengthf( r ) ), 1f, SpriteEffects.None, LayerDepth.TankRader );
            }
        }
