...
namespace Platform.GameDraw.SceneEffects.Particles
{
    ...
    public class Particle : IDrawableObj
    {
        #region Variables
        ...
        {
            if (!isEnd)
                Sprite.alphaSprite.Draw( tex, Coordin.ScreenPos( basePos + curPos ), sourceRect, curColor, MathTools.AziFromRefPos( curDir ), texOrign,
