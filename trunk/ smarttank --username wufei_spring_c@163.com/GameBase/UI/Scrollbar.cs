...
namespace GameBase.UI
{
    public class Scrollbar : Control
    {
        ...
        private void CreateTexture ()
        {
            ...
            {
                case Axis.Horizontal:
                    barTex = new Texture2D( BaseGame.Device, size.X - (scrollUp.size.X + scrollDown.size.X), size.Y, 1, Control.resourceUsage, SurfaceFormat.Color, Control.resourceMode );
                    ...
                    break;
                case Axis.Vertical:
                    barTex = new Texture2D( BaseGame.Device, size.X, size.Y - (scrollUp.size.Y + scrollDown.size.Y), 1, Control.resourceUsage, SurfaceFormat.Color, Control.resourceMode );
        ...
        private void RedrawScroller ()
        {
            ...
            scrollerTex = new Texture2D( BaseGame.Device, sizeX, sizeY, 1, Control.resourceUsage, SurfaceFormat.Color, Control.resourceMode );
