...
namespace GameBase.UI
{
    public class Progressbar : Control
    {
        ...
        {
            border = new Texture2D( BaseGame.Device, width, 18, 1, Control.resourceUsage, SurfaceFormat.Color, Control.resourceMode );
            progressBar = new Texture2D( BaseGame.Device, width - 8, border.Height - 8, 1, Control.resourceUsage, SurfaceFormat.Color, Control.resourceMode );
