...
namespace GameBase.UI
{
    public class Checkbox : Control
    {
        ...
        public Checkbox ( string name, Vector2 position, string text, bool bChecked )//, Font font, Form.Style style )
        {
            ...
            texture[0] = BaseGame.Content.Load<Texture2D>( Path.Combine( Directories.UIContent, "checkbox" ) );
            texture[1] = BaseGame.Content.Load<Texture2D>( Path.Combine( Directories.UIContent, "checkbox_checked" ) );
